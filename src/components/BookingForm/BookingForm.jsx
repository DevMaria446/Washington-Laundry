        ...
        <article className="first-from">
          <div className="Booking">
            ...
            <p className="schedule">
              ...
              <span className="schedule-down">we'll take care of the rest</span>
            </p>
          </div>
              ...
              <div className="main-info">
                <div className="main-info-left">
                  ...
                  <div className="Text-input-1">
                    ...
                    <input className="input-1" type="text" placeholder="John" />
                  </div>{" "}
                  <div className="Text-input-1">
                ...
                <div className="main-info-right">
                  <div className="Text-input-2">
                    <label>Surname</label>
                    <input className="input-2" type="text" placeholder="Doe" />
                  </div>
                  <div className="Text-input-2">
          ...
          <div className="second-from-input">
            ...
            <div className="second-from-input-1">
              ...
              <div className="inside-text">
                ...
                <p className="middle-text">Do you offer pickup and delivery?</p>
                <p className="puls">+</p>
              </div>
              <div className="inside-text">
